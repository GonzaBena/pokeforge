...
.card-fuego::before {
  background: radial-gradient(ellipse at top, var(--type-fire) 0%, transparent 70%);
}
```
...
<div class="starter-card" data-type="planta">...</div>

<!-- Aplica automáticamente el color y resplandor naranja de Fuego -->
<div class="starter-card" data-type="fuego">...</div>

<!-- Aplica automáticamente el color y resplandor azul de Agua -->
<div class="starter-card" data-type="agua">...</div>
```
