...
export async function buildSpeciesInfo(
  totalCount: number,
  force = false,
): Promise<BuildSpeciesInfoResult> {
  ...
  console.log(
    `species-info: resolved ${speciesInfoById.size}/${totalCount} species (${chainIds.size} unique evolution chains)`,
  )
