...
export const EVOLUTION_TRIGGER_NAMES: Record<string, { en: string; es: string }> = {
...
export const UI_TRANSLATIONS: Record<Locale, Translations> = {
  en: {
    nav: {
      ...
      pwaHint: "To install PokeForge, use 'Add to Home Screen' in your browser menu.",
      cloudSynced: 'Synced',
      cloudSyncing: 'Saving...',
      ...
      pwaFeatureOfflineDesc: 'Access the Pokedex and your saved teams without internet connection.',
    ...
    team: {
      ...
      typeMatrixEmpty: 'Add at least one Pokemon to your team to view the type matrix.',
    ...
    strengthsWeaknesses: {
      ...
      guideModalSubtitle: 'Learn how to read defensive multipliers, offense coverage, and KPIs.',
      ...
      guideDefenseDesc: "Evaluates incoming damage from enemy attacks against your team's Pokemon.",
      guideMultiplier4xTitle: '4× Critical Weakness',
      guideMultiplier4xDesc: 'Double weakness (e.g. Grass/Bug vs Fire). Takes quadruple damage.',
      guideMultiplier2xTitle: '2× Weakness',
      guideMultiplier2xDesc: 'Takes super-effective damage (double incoming damage).',
      guideMultiplierHalfTitle: '½× Resistance',
      guideMultiplierHalfDesc: 'Resistant to this type. Takes half incoming damage.',
      guideMultiplierQuarterTitle: '¼× S-Resistance',
      guideMultiplierQuarterDesc: 'Double resistance. Takes only 25% incoming damage.',
      guideMultiplierZeroTitle: '0× Immunity',
      guideMultiplierZeroDesc: 'Completely immune. Takes zero damage from this type.',
    ...
    sync: {
      ...
      readySubtitle: 'You received a team and capture log from your other device.',
      ...
      mergeDesc: 'Adds incoming captures to current ones and sets the received team.',
      replaceTitle: 'Replace all',
      replaceDesc: 'Completely replaces captures and team on this device with incoming data.',
    ...
    syncModal: {
      ...
      cloudHelp: 'Enter this code on your phone or another PC to keep them synced in real time.',
    ...
    blog: {
      ...
      guideIndexSubtitle: 'Explore all sections and stops of this comprehensive guide.',
      ...
      guideNextChapterPendingDesc: 'The next chapter will be published soon. Stay tuned!',
      ...
      downloadsSubtitle: 'Downloadable files, guides, and companion material for this article.',
  ...
  es: {
    ...
    team: {
      title: 'Armar equipo',
      subtitle: 'Completa tu equipo filtrando por generación, tipo y movimientos.',
    ...
    strengthsWeaknesses: {
      ...
      guideMultiplier2xDesc: 'Daño súper eficaz recibido (el doble de daño normal).',
      guideMultiplierHalfTitle: '½× Resistencia',
      guideMultiplierHalfDesc: 'El Pokémon aguanta bien este tipo y recibe la mitad del daño.',
      guideMultiplierQuarterTitle: '¼× Súper Resistencia',
      guideMultiplierQuarterDesc: 'Doble resistencia. Recibe únicamente el 25% del daño.',
      guideMultiplierZeroTitle: '0× Inmunidad',
      guideMultiplierZeroDesc: 'Inmunidad total. No recibe daño de movimientos de este tipo.',
      guideKpiCriticalDesc:
      ...
      guideOffenseMovesDesc: 'Calcula la cobertura según los 4 ataques asignados a cada Pokémon.',
      guideOffenseStabDesc:
    ...
    modal: {
      ...
      chartToggle: 'Alternar entre lista de estadísticas y gráfico hexágono estilo Juez Pokémon',
      nature: 'Naturaleza',
      neutralNature: 'Neutral: no modifica ninguna estadística.',
      increases: 'Aumenta',
      decreases: 'Disminuye',
      captureHint: 'Capturá este Pokémon para personalizar sus stats y naturaleza.',
    ...
    sync: {
      ...
      heroDesc: 'Para transferir tus capturas y tu equipo entre dispositivos de forma instantánea:',
      step1: 'En tu computadora, hacé clic en el botón Sincronizar en la barra de navegación.',
      step2: 'Abrí la cámara de tu celular y apuntá al código QR que aparece en pantalla.',
      ...
      readySubtitle: 'Recibiste un equipo y registro de capturas de tu otro dispositivo.',
    ...
    blog: {
      ...
      guideIndexSubtitle: 'Explora todas las secciones y paradas de esta guía detallada.',
...
export function getEvolutionTriggerName(trigger: string, locale: Locale): string {
...
export function getGameTitle(gameKey: string, locale: Locale = 'es', fallback?: string): string {
  const match =
    GAME_NAMES[gameKey] ??
    (GAME_NAMES_BY_DISPLAY[gameKey] ? GAME_NAMES[GAME_NAMES_BY_DISPLAY[gameKey]] : undefined)
  if (match) {
...
export function getNatureName(natureKey: string | null | undefined, locale: Locale = 'es'): string {
  if (!natureKey) return ''
