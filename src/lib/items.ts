...
export const ITEMS_DATABASE: ItemData[] = [
  ...
  },
  {
    ...
    effect: {
      ...
      descriptionEs: "Aumenta la Defensa y la Defensa Especial un 50% si el Pokémon aún puede evolucionar.",
  ...
  },
  {
    ...
    effect: {
      ...
      descriptionEs: "Aumenta la potencia de los movimientos de tipo Dragón y Psíquico de Latios y Latias un 20%.",
      descriptionEn: "Boosts the power of Dragon and Psychic moves used by Latios and Latias by 20%.",
    },
  ...
  // --- Inmunidades y Alteraciones de Tipo (Defensive / Immunities) ---
  {
    ...
    effect: {
      ...
      descriptionEs: "Otorga inmunidad total frente a movimientos de tipo Tierra y riesgos en el suelo. Explota al recibir un golpe.",
      descriptionEn: "Grants full immunity to Ground-type moves and ground hazards. Pops when hit by an attack.",
    },
  ...
  },
  {
    ...
    effect: {
      ...
      descriptionEs: "Anula todas las inmunidades por tipo del portador, permitiendo que cualquier tipo le cause daño.",
      descriptionEn: "Removes all type immunities from the holder, allowing any move type to hit it.",
    },
  ...
  },
  {
    ...
    effect: {
      ...
      descriptionEs: "Reduce la Velocidad un 50% y anula la inmunidad a Tierra de los Pokémon de tipo Volador o con Levitación.",
      descriptionEn: "Cuts Speed by 50% and removes Ground immunity from Flying types or Pokémon with Levitate.",
    },
  ...
  },
  {
    ...
    icon: "footprints",
    effect: {
      descriptionEs: "Protege al portador de los efectos y daño de todas las trampas de entrada (Trampa Rocas, Púas, Púas Tóxicas, Red Viscosa).",
      descriptionEn: "Protects the holder from the effects and damage of entry hazards (Stealth Rock, Spikes, Toxic Spikes, Sticky Web).",
    },
  ...
  },
  {
    ...
    icon: "shield-alert",
    effect: {
      descriptionEs: "Si el portador tiene los PS al máximo, sobrevive a cualquier ataque que causaría K.O. con 1 PS.",
  ...
  },
  {
    ...
    icon: "shield",
    effect: {
      descriptionEs: "Inflige un daño equivalente a 1/6 de los PS máximos al atacante cuando hace contacto.",
  ...
  },
  {
    ...
    icon: "flask-conical",
    effect: {
      descriptionEs: "Restaura 1/16 de PS cada turno a Pokémon de tipo Veneno; inflige 1/8 de daño por turno a otros tipos.",
      descriptionEn: "Restores 1/16 HP each turn to Poison types; damages other types by 1/8 HP each turn.",
    },
  ...
  // --- Potenciadores de Tipo y Daño (Type Boosters & Damage) ---
  {
    ...
    effect: {
      boostMultiplier: 1.3,
      descriptionEs: "Aumenta la potencia de todos los ataques un 30%, a cambio del 10% de los PS máximos por golpe.",
  ...
  // --- Tablas de Tipo (Plates) ---
  {
    ...
    effect: {
      ...
      boostedType: "fire",
      boostMultiplier: 1.2,
      descriptionEs: "Aumenta la potencia de los ataques Fuego un 20% y cambia el tipo de Arceus a Fuego.",
  ...
  },
  {
    ...
    effect: {
      ...
      boostedType: "water",
      boostMultiplier: 1.2,
      descriptionEs: "Aumenta la potencia de los ataques Agua un 20% y cambia el tipo de Arceus a Agua.",
  ...
  },
  {
    ...
    effect: {
      ...
      boostedType: "grass",
      boostMultiplier: 1.2,
      descriptionEs: "Aumenta la potencia de los ataques Planta un 20% y cambia el tipo de Arceus a Planta.",
  ...
  },
  {
    ...
    effect: {
      ...
      boostedType: "electric",
      boostMultiplier: 1.2,
      descriptionEs: "Aumenta la potencia de los ataques Eléctrico un 20% y cambia el tipo de Arceus a Eléctrico.",
  ...
  },
  {
    ...
    effect: {
      ...
      boostedType: "dragon",
      boostMultiplier: 1.2,
      descriptionEs: "Aumenta la potencia de los ataques Dragón un 20% y cambia el tipo de Arceus a Dragón.",
  ...
  },
  {
    ...
    effect: {
      ...
      boostedType: "fairy",
      boostMultiplier: 1.2,
      descriptionEs: "Aumenta la potencia de los ataques Hada un 20% y cambia el tipo de Arceus a Hada.",
  ...
  // --- Bayas de Reducción de Daño Supereficaz (Type-Resist Berries) ---
  {
    ...
    effect: {
      resistBerryType: "ice",
      descriptionEs: "Reduce a la mitad (½×) el daño del primer ataque supereficaz de tipo Hielo recibido.",
  ...
  },
  {
    ...
    effect: {
      ...
      descriptionEs: "Reduce a la mitad (½×) el daño del primer ataque supereficaz de tipo Fuego recibido.",
  ...
  },
  {
    ...
    effect: {
      ...
      descriptionEs: "Reduce a la mitad (½×) el daño del primer ataque supereficaz de tipo Agua recibido.",
  ...
  },
  {
    ...
    effect: {
      ...
      descriptionEs: "Reduce a la mitad (½×) el daño del primer ataque supereficaz de tipo Planta recibido.",
  ...
  },
  {
    ...
    effect: {
      ...
      descriptionEs: "Reduce a la mitad (½×) el daño del primer ataque supereficaz de tipo Eléctrico recibido.",
  ...
  },
  {
    ...
    effect: {
      ...
      descriptionEs: "Reduce a la mitad (½×) el daño del primer ataque supereficaz de tipo Tierra recibido.",
  ...
  },
  {
    ...
    effect: {
      ...
      descriptionEs: "Reduce a la mitad (½×) el daño del primer ataque supereficaz de tipo Volador recibido.",
  ...
  },
  {
    ...
    effect: {
      ...
      descriptionEs: "Reduce a la mitad (½×) el daño del primer ataque supereficaz de tipo Lucha recibido.",
  ...
  },
  {
    ...
    effect: {
      ...
      descriptionEs: "Reduce a la mitad (½×) el daño del primer ataque supereficaz de tipo Acero recibido.",
  ...
  },
  {
    ...
    effect: {
      ...
      descriptionEs: "Reduce a la mitad (½×) el daño del primer ataque supereficaz de tipo Hada recibido.",
  ...
  // --- Objetos Competitivos y de Utilidad Estratégica ---
  {
    ...
    effect: {
      descriptionEs: "Activa Paleosíntesis o Carga Cuark para potenciar la estadística más alta (+30% en Atk/Def/SpA/SpD o +50% en Vel).",
      descriptionEn: "Activates Protosynthesis or Quark Drive to boost highest stat (+30% Atk/Def/SpA/SpD or +50% Spe).",
    },
  ...
  },
  {
    ...
    icon: "dices",
    effect: {
      descriptionEs: "Garantiza que los movimientos de golpes múltiples conecten al menos 4-5 veces.",
  ...
  },
  {
    ...
    icon: "shield",
    effect: {
      descriptionEs: "Inmuniza al portador contra los efectos secundarios de los movimientos enemigos (retroceso, parálisis, etc.).",
      descriptionEn: "Protects the holder from secondary effects of enemy attacks (flinch, stat drops, status).",
    },
  ...
  },
  {
    ...
    icon: "gem",
    effect: {
      descriptionEs: "Evita que las habilidades o movimientos de los rivales bajen las estadísticas del portador.",
      descriptionEn: "Prevents other Pokémon's moves and abilities from lowering the holder's stats.",
    },
  ...
  },
  {
    ...
    icon: "glasses",
    effect: {
      descriptionEs: "Inmuniza al portador contra movimientos de esporas y polvos, así como daño por clima (Tormenta de Arena/Granizo).",
  ...
  },
  {
    ...
    icon: "shield-alert",
    effect: {
      descriptionEs: "Aumenta el Ataque y el Ataque Especial en 2 niveles (+100%) al recibir un golpe supereficaz.",
      descriptionEn: "Sharply raises Attack and Sp. Atk (+2 stages) when hit by a super-effective move.",
    },
  ...
  },
  {
    ...
    icon: "flame",
    effect: {
      descriptionEs: "Quema al portador al final del primer turno (ideal para Agallas o Escama Especial).",
      descriptionEn: "Inflicts burn on the holder at the end of the turn (synergizes with Guts/Marvel Scale).",
    },
  ...
  },
  {
    ...
    icon: "skull",
    effect: {
      descriptionEs: "Envenena gravemente al portador al final del primer turno (ideal para Antídoto o Ímpetu Tóxico).",
      descriptionEn: "Badly poisons the holder at the end of the turn (synergizes with Poison Heal/Toxic Boost).",
    },
  ...
  },
  {
    ...
    icon: "zap",
    effect: {
      descriptionEs: "Permite ejecutar movimientos de dos turnos (como Rayo Solar o Rayo Meteórico) en un solo turno.",
      descriptionEn: "Allows two-turn moves (like Solar Beam or Meteor Beam) to charge and attack in 1 turn.",
    },
  ...
  },
  {
    ...
    icon: "zap",
    effect: {
      descriptionEs: "Otorga una probabilidad del 20% de atacar primero dentro de su misma prioridad.",
  ...
  },
  {
    ...
    icon: "crown",
    effect: {
      descriptionEs: "Los movimientos que causan daño tienen un 10% de probabilidad de amedrentar al objetivo.",
  ...
  },
  {
    ...
    icon: "crosshair",
    effect: {
      descriptionEs: "Aumenta la probabilidad de asestar golpes críticos en 1 nivel. Permite evolucionar a Sneasel.",
  ...
  },
  {
    ...
    icon: "shield",
    effect: {
      descriptionEs: "Otorga un 10% de probabilidad de resistir cualquier golpe fulminante con 1 PS.",
  ...
  },
  {
    ...
    icon: "search",
    effect: {
      descriptionEs: "Aumenta la precisión de los movimientos en un 20% si el portador ataca después del rival.",
  ...
  },
  {
    ...
    icon: "sprout",
    effect: {
      descriptionEs: "Aumenta en un 30% la cantidad de PS recuperados mediante movimientos de drenaje o absorción.",
  ...
  },
  {
    ...
    icon: "activity",
    effect: {
      descriptionEs: "Potencia un movimiento un 20% adicional cada vez que se usa consecutivamente (hasta un máximo de +100%).",
  ...
  },
  {
    ...
    icon: "sprout",
    effect: {
      descriptionEs: "Elimina efectos de provocación, atracción, anulación y bloqueo como Mofa o Tormento. De un solo uso.",
      descriptionEn: "Snaps the holder out of infatuation, Taunt, Encore, Torment, or Disable. Single-use.",
    },
  ...
  },
  {
    ...
    icon: "mic",
    effect: {
      descriptionEs: "Aumenta el Ataque Especial en 1 nivel tras usar un movimiento de sonido. De un solo uso.",
  ...
  },
  {
    ...
    icon: "shield-alert",
    effect: {
      descriptionEs: "Aumenta la Velocidad en 2 niveles si un movimiento falla por falta de precisión. De un solo uso.",
      descriptionEn: "Sharply raises Speed (+2 stages) if a move misses due to accuracy. Single-use.",
    },
  ...
  },
  {
    ...
    icon: "shield",
    effect: {
      descriptionEs: "Inmuniza al portador contra efectos derivados del contacto físico (Casco Dentado, Punta Acero, etc.).",
  ...
  },
  {
    ...
    icon: "clock",
    effect: {
      descriptionEs: "Reduce la Velocidad del portador en 1 nivel cuando se activa Espacio Raro. De un solo uso.",
  ...
  },
  {
    ...
    icon: "map",
    effect: {
      descriptionEs: "Extiende la duración de los terrenos creados por el portador de 5 a 8 turnos.",
  ...
  },
  {
    ...
    icon: "wind",
    effect: {
      descriptionEs: "Extiende la duración de la tormenta de arena provocada por el usuario de 5 a 8 turnos.",
  ...
  },
  {
    ...
    icon: "snowflake",
    effect: {
      descriptionEs: "Extiende la duración de la nieve o granizo provocado por el usuario de 5 a 8 turnos.",
  ...
  },
  {
    ...
    icon: "sparkles",
    effect: {
      descriptionEs: "Permite al portador moverse en primer lugar dentro de su prioridad cuando sus PS caen por debajo del 25%. De un solo uso.",
      descriptionEn: "Holder moves first in their priority bracket when HP drops below 25%. Single-use.",
    },
