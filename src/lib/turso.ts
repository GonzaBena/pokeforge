...
export function isTursoConfigured(): boolean {
  const url =
    process.env.TURSO_DATABASE_URL || (import.meta.env && import.meta.env.TURSO_DATABASE_URL)
  const authToken =
    process.env.TURSO_AUTH_TOKEN || (import.meta.env && import.meta.env.TURSO_AUTH_TOKEN)
