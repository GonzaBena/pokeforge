---
title: "Capítulo 1: Pueblo Paleta y los Primeros Pasos"
description: Elección del Pokémon inicial, primera batalla contra el rival, Ruta 1 y recado del Profesor Oak en Ciudad Verde.
pubDate: 2026-09-05
category: guias
tags:
  - Kanto
  ...
  - PuebloPaleta
  - CiudadVerde
coverImage: ./assets/00-PuebloPaleta-banner.png
readingTime: 15 min
author: gonzo
...
---
## 1.0: Pueblo Paleta
![Mapa de Pueblo Paleta|banner](./assets/00-PuebloPaleta.png)
*Mapa de Pueblo Paleta*
### Objetos
...
> **Consejo**: Tu rival elegirá automáticamente el inicial que tiene ventaja de tipo sobre el tuyo. Inmediatamente después tendrás tu primer combate. Usa ataques directos como *Placaje* o *Arañazo* sin dudar.
...
| Objeto             | Tipo       | Ubicación                                                                                                                                       |
| ------------------ | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| Poción de Muestra  | Consumible | Habla con el encargado de la tienda que pasea por la ruta para recibir una *Poción* gratuita. Es la primera persona que ves al salir del pueblo. |
</div>

## 1.2.1: Visita rápida a Ciudad Verde
![Mapa de Ciudad Verde|banner](./assets/01-CiudadVerde.png)
*Mapa de Ciudad Verde*

Al llegar a **Ciudad Verde**, cura a tus Pokémon en el **Centro Pokémon** y entra en la Tienda Pokémon (*Poké Mart*). El vendedor te pedirá que le lleves un paquete especial al Profesor Oak.

<div style="display:flex; justify-content: center; gap: 2rem;">

![Centro Pokémon|sprite](./assets/CentroPokemon.webp)
*Centro Pokémon*

![Tienda|sprite](./assets/Tienda.webp)
*Tienda*
</div>
...
Regresa a Pueblo Paleta y entrégale el encargo. Al hacerlo entrará tu rival y el Prof. Oak les recompensará oficialmente con sus **Pokédex** y sus primeras 5 **Poké Balls**. Luego, tu rival te hablará sobre su hermana (*Dalia*) y que ella posee un mapa.
...
<div class="table-columns__col table-columns__col--auto shop">
